...
pub mod service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_current_min_rent_for_token_account(
            &mut self,
            request: impl tonic::IntoRequest<
                super::GetCurrentMinRentForTokenAccountRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::GetCurrentMinRentForTokenAccountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protochain.solana.program.token.v1.Service/GetCurrentMinRentForTokenAccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn create_associated_token_account(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateAssociatedTokenAccountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateAssociatedTokenAccountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protochain.solana.program.token.v1.Service/CreateAssociatedTokenAccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod service_server {
    ...
    pub trait Service: Send + Sync + 'static {
        ...
        async fn get_current_min_rent_for_token_account(
            &self,
            request: tonic::Request<super::GetCurrentMinRentForTokenAccountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetCurrentMinRentForTokenAccountResponse>,
            tonic::Status,
        >;
        ...
        async fn create_associated_token_account(
            &self,
            request: tonic::Request<super::CreateAssociatedTokenAccountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateAssociatedTokenAccountResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/protochain.solana.program.token.v1.Service/GetCurrentMinRentForTokenAccount" => {
                    #[allow(non_camel_case_types)]
                    struct GetCurrentMinRentForTokenAccountSvc<T: Service>(pub Arc<T>);
                    impl<
                        T: Service,
                    > tonic::server::UnaryService<
                        super::GetCurrentMinRentForTokenAccountRequest,
                    > for GetCurrentMinRentForTokenAccountSvc<T> {
                        type Response = super::GetCurrentMinRentForTokenAccountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Service>::get_current_min_rent_for_token_account(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetCurrentMinRentForTokenAccountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/protochain.solana.program.token.v1.Service/CreateAssociatedTokenAccount" => {
                    #[allow(non_camel_case_types)]
                    struct CreateAssociatedTokenAccountSvc<T: Service>(pub Arc<T>);
                    impl<
                        T: Service,
                    > tonic::server::UnaryService<
                        super::CreateAssociatedTokenAccountRequest,
                    > for CreateAssociatedTokenAccountSvc<T> {
                        type Response = super::CreateAssociatedTokenAccountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Service>::create_associated_token_account(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateAssociatedTokenAccountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
