...
// Account types
export type { Account as AccountSchema } from './protosol/solana/account/v1/account_pb';
...
// Common types
export type { KeyPair } from './protosol/solana/type/v1/keypair_pb';

export type { CommitmentLevel } from './protosol/solana/type/v1/commitment_level_pb';
